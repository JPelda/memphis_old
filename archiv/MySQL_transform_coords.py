...
if __name__ == "__main__":
    ...
    for x, y, inhab in zip(df['x_mp_100m'], df['y_mp_100m'], df['inhabitans']):
        x_4326, y_4326 = transform_coordinates(x, y, from_CS='epsg:3035',
                                           into_CS='epsg:4326')
        print(("x: {}, y: {}, inhab: {}").format(x_4326, y_4326, inhab))
    #val = 4
